 ...
 * them in-tab. `open(onDismiss, onRestore?)` returns an entryId; the optional restore callback
 * opts retained file navigation into Forward while its owner is mounted; `close(entryId)` dismisses
