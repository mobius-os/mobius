...
export const CODEX_MODELS = [
  // gpt-5.4-codex requires an OpenAI API account; ChatGPT-account auth
  // (the path Möbius's Codex bridge uses) returns 400
  // invalid_request_error. Drop until per-auth model gating is in
  // place — re-add when ChatGPT-account upgrades support it or when we
  // wire API-key auth as a separate option.
