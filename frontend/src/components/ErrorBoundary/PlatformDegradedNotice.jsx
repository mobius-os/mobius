...
const VARIANTS = {
  backend: {
    ...
    body:
      'Möbius kept your chats safe and opened a working version. ' +
      'An agent can fix the latest changes, or you can continue with the previous version.',
    diagnostic:
      'Möbius is serving its protected fallback because the latest platform ' +
      'generation did not finish loading. The latest source is preserved but ' +
      'is not running.',
