...
export default function Drawer({
  ...
  // without easing.
  const dragStart = useRef(null) // { x, y, pointerId } or null
  ...
  // Click suppression remains a second line of defence for a horizontal flick
  // that still produces a compatibility click on the row beneath the finger.
