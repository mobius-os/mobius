...
import { peerRecordTool, peerTime, projectPeerTimeline, foldPeerActivity } from './peerTimeline.js'
...
export function usePeerTimeline(chatId, messages, enabled, activeTools, activeMirrorIndex = -1) {
  ...
  const projection = useMemo(() => foldPeerActivity(messages, projectPeerTimeline(messages, history, chatId, activeTools), chatId, activeMirrorIndex), [messages, history, chatId, activeTools, activeMirrorIndex])
