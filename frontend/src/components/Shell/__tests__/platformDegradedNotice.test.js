...
test('the degraded notice offers agent repair or the working fallback directly', () => {
  ...
  assert.match(backend, /Keep using this version/)
  ...
  assert.match(frontend, /Keep using this version/)
})
