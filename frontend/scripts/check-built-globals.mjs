...
const ALLOWED_GLOBALS = new Set([
  ...
  'Error', 'escape', 'eval', 'EvalError', 'FinalizationRegistry', 'Float16Array',
  'Float32Array', 'Float64Array', 'Function', 'globalThis', 'Infinity', 'Int8Array',
  'Int16Array', 'Int32Array', 'Intl', 'isFinite', 'isNaN', 'JSON', 'Map',
  'Iterator', 'Math', 'NaN', 'Number', 'Object', 'parseFloat', 'parseInt', 'Promise',
  'Proxy', 'RangeError', 'ReferenceError', 'Reflect', 'RegExp', 'Set',
  'SharedArrayBuffer', 'String', 'Symbol', 'SyntaxError', 'TypeError',
  'Uint8Array', 'Uint8ClampedArray', 'Uint16Array', 'Uint32Array',
  'structuredClone', 'undefined', 'unescape', 'URIError', 'WeakMap', 'WeakRef', 'WeakSet',
  'WebAssembly',
  ...
  'CompressionStream', 'createImageBitmap', 'crypto', 'CSS', 'CustomEvent',
  'DecompressionStream', 'devicePixelRatio', 'document', 'DOMException',
  'DOMMatrix', 'DOMMatrixReadOnly', 'DOMParser', 'DOMRect',
  'Element', 'Event', 'EventSource', 'fetch', 'File', 'FileReader', 'FormData',
  'FontFace', 'getComputedStyle', 'GPUBufferUsage', 'Headers', 'history',
  'HTMLAnchorElement', 'HTMLButtonElement', 'HTMLCanvasElement', 'HTMLElement',
  'HTMLFormElement', 'HTMLInputElement', 'Image', 'ImageData', 'ImageDecoder',
  'indexedDB', 'IntersectionObserver', 'localStorage', 'location', 'matchMedia',
  'MessageChannel', 'MessageEvent', 'MutationObserver', 'navigation',
  'navigator', 'Node', 'NodeFilter', 'Notification', 'OffscreenCanvas', 'Path2D',
  'performance',
  ...
  'Range', 'Sanitizer', 'ShadowRoot', 'TextDecoder', 'TextEncoder', 'URL',
  'URLSearchParams',
