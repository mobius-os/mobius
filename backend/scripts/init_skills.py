...
SEED_VERSION = "4"  # bump when the baked seed skills change (v2: added dreaming.md; v3: const-CSS styling standard in building-apps.md + new app-component-shapes.md; v4: added embedded-app-agent.md)
