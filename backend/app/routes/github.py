"""Reviewed GitHub contribution publication and Autopilot routes.

GitHub credential management, local source inspection, and the bounded
read-only proxy live in ``routes/github_access.py``. This module owns the
write-capable contribution boundary. A standalone Send consumes one
