...
_SCHEMA_MIGRATIONS = (
  ...
  ("0024_shared_app_retention", _add_shared_app_retention),
  ("0025_shared_app_path_state", _migrate_shared_app_state_files),
  ("0026_project_artifact_drawer_state", _add_project_artifact_drawer_state),
)
