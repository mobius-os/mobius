...
# them. Mirrors the order in the frontend's CLAUDE_MODELS / CODEX_MODELS
# lists — keep in sync when a model lands at the top of either list.
# Listing all known values lets the snapshot logic
