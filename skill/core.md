...
| `reflection.md` | The nightly unattended run: improve long-term user productivity by learning from chats, refining skills, reviewing Memory health, stewarding resource/cost trends with adaptive checks, hardening used apps, researching known interests, and writing the morning brief. Read it when running as the Reflection agent or wiring its cron. |
