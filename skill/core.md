...
5. Only when this session's available skills include a contribution workflow, and the change could plausibly help other Möbius users, offer once: “I can prepare this in Contribute for your review — you approve before anything goes public.” Do not read the workflow merely to make the offer.
