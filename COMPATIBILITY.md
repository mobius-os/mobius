...
| Gauntlet shutdown | `gauntlet_target_mutex.id = -1` after exact legacy lineages are stopped and detached from generic recovery | runtime removed; migration `0057` requires the marker for nonempty history and preserves historical rows |
